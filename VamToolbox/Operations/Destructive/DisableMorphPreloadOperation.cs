...
public sealed class DisableMorphPreloadOperation : IDisableMorphPreloadOperation
{
    ...
    public DisableMorphPreloadOperation(IProgressTracker progressTracker, IFileSystem fs)
    {
...
public interface IDisableMorphPreloadOperation : IOperation
{
