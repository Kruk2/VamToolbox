...
public class JsonScannerTests
{
    ...
    [InlineData(@"  ""receiverTargetName"" : ""clothing:JaxZoa.JaxEffects.latest:Jax_Effects_CumCornerRight.vam"", ", "clothing:JaxZoa.JaxEffects.latest:Jax_Effects_CumCornerRight.vam")]
    ...
    public void Scan_ShouldFindNotMatch(string line)
    {
        var (reference, error) = Scan(line);
    ...
    [InlineData(@"  ""xcasdas"" : ""Nuflauer.BDSM_session.4:/Custom/Sounds/SFX/Pee_ground.mp3"",")]
    [InlineData(@"  ""uvzsid"" : ""noheadnoleg.AllScenes.latest:whatever.vmi"", ")]
    [InlineData(@"    ""preqwesetFilePsath"" : ""SELF:/Custom/Atom/Person/Pose/Preset_we-invaderfootjob.vap"" ")]
    [InlineData(@"    ""itqqd"" : ""SELF:/Custom/Hair/Female/vecterror/kate hair 1b/kate hair 1b.vam"", ")]
    [InlineData(@"	""plugtqin#0"" : ""Custom/Scripts/ImprovedPoV.cs""  ")]
    [InlineData(@"""plugeqszin#0"" : ""./detention/RT_LipSync.dll""")]
    [InlineData(@"   ""stogdsrePath"" : ""SELF:/Custom/SubScene/eponge/sec_base/bosskneelBJ.json""")]
